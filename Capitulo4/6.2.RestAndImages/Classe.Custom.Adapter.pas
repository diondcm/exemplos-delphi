...
type
  ...
  public
    procedure ResetView(const Item: TListItem);// Exibir primeiro
...
constructor TCustomAdapter.Create(AParent: TListViewBase; AStrings: TStringList);
begin
  inherited Create;
...
procedure TCustomAdapter.SetOnButtonClick(const Value: TNotifyEvent);
begin

...
type
  TWebModulePrincipal = class(TWebModule)
    ...
    DSServer1: TDSServer;
    DSServerClassDados: TDSServerClass;
    ServerFunctionInvoker: TPageProducer;
    ReverseString: TPageProducer;
    WebFileDispatcher1: TWebFileDispatcher;
    DSProxyGenerator1: TDSProxyGenerator;
    DSServerMetaDataProvider1: TDSServerMetaDataProvider;
    procedure DSServerClassDadosGetClass(DSServerClass: TDSServerClass;
...
uses GetDadosUnit, Web.WebReq;

procedure TWebModulePrincipal.DSServerClassDadosGetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := GetDadosUnit.TGetDados;
end;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := GetDadosUnit.TGetDados.ClassName

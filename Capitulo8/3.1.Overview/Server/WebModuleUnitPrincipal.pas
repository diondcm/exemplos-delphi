...
type
  TWebModulePrincipal = class(TWebModule)
    ...
    DSServer1: TDSServer;
    DSServerClassSMGeral: TDSServerClass;
    ServerFunctionInvoker: TPageProducer;
    ReverseString: TPageProducer;
    WebFileDispatcher1: TWebFileDispatcher;
    DSProxyGenerator1: TDSProxyGenerator;
    DSServerMetaDataProvider1: TDSServerMetaDataProvider;
    procedure DSServerClassSMGeralGetClass(DSServerClass: TDSServerClass;
...
uses ServerMethodsGeral, Web.WebReq;

procedure TWebModulePrincipal.DSServerClassSMGeralGetClass(
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := ServerMethodsGeral.TSMGeral.ClassName

...
type
  TfrmCriaClasse = class(TForm)
    buttonCriaClasse: TButton;
    procedure buttonCriaClasseClick(Sender: TObject);
  private
...
procedure TfrmCriaClasse.buttonCriaClasseClick(Sender: TObject);
begin
...
procedure TfrmCriaClasse.WMSysCommand(var Message: TWMSysCommand);
begin
